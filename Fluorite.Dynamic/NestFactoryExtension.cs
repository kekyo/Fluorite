...
namespace Fluorite
{
    public static class NestFactoryExtension
    {
        public static Nest<TInterface> Create<TInterface>(
            ...
            _.Create(settings, DynamicProxyFactory<TInterface>.Instance);
            ...
            this NestFactory _, string serverAddress, int port, bool performSecureConnection)
        {
            ...
            return _.Create(NestSettings.Create(JsonSerializer.Instance, transport), DynamicProxyFactory<TInterface>.Instance);
        }
